...
public function showmaintain(Request $request){
    ...
    public function timeCheck($dv_id, $month, $year){
        return view('ktv.device.timeCheck')->with(['$dv_id'=>$dv_id, 'month'=>$month, 'year'=>$year]);
    }
    ...
    return view('ktv.device.maintain_check')->with(['device'=>$dev,'maintainAct'=>$dv,'checked'=>$ch,'ms'=>$ms,'ys'=>$ys]);
    ...
    //export excel device via device_type
    // public function exportDvt(Request $request ,$id)
    // {
    //         $dvtype = Device_type::find($id);
    //         $dvt = $id;
    //         return Excel::download(new DeviceExportQuery($dvt),'DS_loai_TB_'.$dvtype->dv_type_name.'.xlsx');
    // }
    // //export device vie department
    // public function exportDep(Request $request, $id)
    // {
        
    //     $dept = Department::find($id);
    //     $dep = $id;
    //     return Excel::download(new DeviceExportQuery($dep),'DS_loai_TB_'.$dept->department_name.'.xlsx');
    // }
